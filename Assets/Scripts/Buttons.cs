...
public class Buttons : MonoSingleton<Buttons>
{
    ...
    public void StartButtonPrice()
    {
        ...
        if (price.tableCount > gameManager.researchPoint && AdManager.current.count <= AdManager.current.maxCount && ýtemData.field.tableCount % 6 != 0)
        {
        ...
        if (price.runnerCount > gameManager.money && AdManager.current.count <= AdManager.current.maxCount && ýtemData.field.tableCount % myDoPath.runnerCount != 0)
        {
        ...
        if (price.bobinCount > gameManager.money && AdManager.current.count <= AdManager.current.maxCount && ýtemData.field.tableCount % myDoPath.runnerCount != 0)
        {
